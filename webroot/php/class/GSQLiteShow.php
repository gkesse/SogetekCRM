...
class GSQLiteShow extends GWidget {
    ...
    public function run() {
        ...
        echo sprintf("<input class='item' type='number' id='page' name='page' value='%d' min='1' max='%d' maxlength='6' size='6' 
        ...
        echo sprintf("<input style='min-width: 60px;' class='item' type='number' id='page' name='page' value='%d' min='10' max='50' maxlength='6' size='6' step='10'
