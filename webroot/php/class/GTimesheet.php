...
class GTimesheet extends GWidget {
    ...
    public function run() {
        ...
        echo sprintf("<div class='field'><input class='input' type='text' id='collaborator' name='collaborator' placeholder='Gérard KESSE' required/></div>\n");
        echo sprintf("</div>\n");
        echo sprintf("<div class='row'>\n");
        echo sprintf("<div class='key'><label class='label' for='manager'>Manager :</label></div>\n");
        echo sprintf("<div class='field'><input class='input' type='text' id='manager' name='manager' placeholder='Yvon MOUTSINGA' required/></div>\n");
        echo sprintf("</div>\n");
        echo sprintf("<div class='row'>\n");
        echo sprintf("<div class='key'><label class='label' for='client'>Client :</label></div>\n");
        echo sprintf("<div class='field'><input class='input' type='text' id='client' name='client' placeholder='PMC Carrus Groupe' required/></div>\n");
        echo sprintf("</div>\n");
        echo sprintf("<div class='row'>\n");
        echo sprintf("<div class='key'><label class='label' for='address'>Adresse :</label></div>\n");
        echo sprintf("<div class='field'><input class='input' type='text' id='address' name='address' placeholder='56 Avenue Raspail, 94100 Saint-Maur-des-Fossés' required/></div>\n");
        echo sprintf("</div>\n");
        echo sprintf("</div>\n");
        // table
        echo sprintf("<div class='item'>\n");
